...
| `task` | Hierarquia `plan ⊃ epic ⊃ issue ⊃ task`, **contexto** (`context_of`: pai/bloqueadores/filhos, D125), **progresso por épico** (`progress_of`/`epic_of`, D127), ciclo de vida, **espécie** (`--kind`, D113), dono derivado (`claim`, D114), **papel/modo** derivados (D115/D116), **impacto** (`impact`/`is_actionable`, D106/D109/D120), **tags/âncoras** (D104), **templates de plano** (`--prompt`/`--from`, D105) e **programas externos** (D119). |
