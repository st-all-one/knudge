...
>
> **Decisões:** D15, D20, D21, D22, D23, D24, D25, D26, D27, D28, D48 (revision), D84.
...
- **Decisões:** D48.
- **Aceite:** N updates → `revision = N`; `get(id, history=true)` retorna os estados.
...
- [ ] Crash-injection cobre tmp/rename, nota/evento e rebuild.
- [ ] Lock e dedup passam em stress de concorrência.
- [ ] Nenhum caminho de remoção deixa derivado órfão.
- [ ] Sem resíduo de tmp/lock; log de eventos segmentado.
