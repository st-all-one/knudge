...
> de projeto e `sync`.
>
> **Decisões:** D29, D30, D31, D32, D33, D34, D57, D59 (registro), D60, D61, D62, D63, D64, D91.
...
- [ ] `onboard` idempotente e worktree-aware.
- [ ] Exclusão e `persist_in_project` testados nos quatro quadrantes.
- [ ] `sync` gera commit correto no worktree certo.
