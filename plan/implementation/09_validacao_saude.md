...
>
> **Decisões:** D16, D17, D18, D19, D43, D46, D48, D54, D55, D84, D86, D87, D99.
...
- **Objetivo:** `validators.toml` executável; resolução
...
- [x] Nenhuma nota isolada derruba um comando.
- [x] `doctor --fix` idempotente e a divergência de derivado é detectada.
- [x] Stale é sinalizado com motivo; confiança é sempre derivada.
