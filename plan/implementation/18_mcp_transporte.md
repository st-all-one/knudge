...
- [ ] Codec JSON-RPC puro com códigos canônicos.
- [ ] Handshake, `ping` e notificações corretos.
- [ ] Tools dos 3 gatilhos (+ `status`) expostas e testadas.
- [ ] Transporte stdio com EPIPE→0 e stdout limpo.
- [ ] Binário configurável e recipe atualizado.
- [ ] `make check` verde; matriz e docs atualizados.
