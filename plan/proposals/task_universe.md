...
> **Status:** C1–C4 ainda pendentes; **PR0.5** (Programa externo, §10.7/D119) implementado —
> `task::program`, `kd task graph --program`, check `program-anchor` e config `programs.glob`.
>
